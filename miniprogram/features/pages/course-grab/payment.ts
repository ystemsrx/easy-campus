...
import {
  ...
  launchWechatPayment,
} from "../../services/course-grab-payment";
...
} from "../../store/course-grab-payment";
import {
  captureSessionLease,
...
function definePaymentPage<
  D extends WechatMiniprogram.Page.DataOption,
  C extends WechatMiniprogram.Page.CustomOption,
>(options: WechatMiniprogram.Page.Options<D, C> & { data: D }) {
  return options;
}

export const courseGrabPaymentPage = definePaymentPage({
  openOrders() {
    haptic("light");
    void navigateTo(
