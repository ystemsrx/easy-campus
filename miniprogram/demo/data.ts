...
export function demoDormStatus(): AutoDormCheckStatus {
  return {
    ...
    agreementAcceptedAt: demoTimestamp(-30),
    enabled: true,
    effectiveEnabled: true,
    checkInStatus: "pending",
    checkInStartTime: "21:00",
    checkInEndTime: "23:00",
    schoolCheckInStartTime: "21:00",
    schoolCheckInEndTime: "23:00",
    plannedCheckInAt: demoTimestamp(0, 22),
    plannedCheckInDate: demoDate(),
